...
// Função para imprimir todos os atletas da lista
...
void escolhertipo(sportlist* lista, int numRegistros) {
    ...
    if (tipoOrdenacao == 1) { 
        ...
        cout << " _________________ " << endl;
        cout << "| Opcao invalida! |" << endl; // Mensagem de erro para opção inválida
        cout << " ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾ " << endl;
    }           
...
void salvarDados(const string& nomeArquivo, sportlist* lista, int numRegistros) {
    ...
    if (nomeArquivo.find(".csv") != string::npos) {
        ...
        if (!saida) { // Verifica se o arquivo foi aberto corretamente
            ...
            cout << "| Erro ao salvar os dados no arquivo! |" << endl; // Mensagem de erro
            cout << " ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾ " << endl;
            return; // Sai da função
        }
        saida << "Nome,Idade,Nacionalidade,Altura,Peso,Modalidade\n"; // Escreve o cabeçalho
        ...
        cout << " ______________________________________ " << endl;
        cout << "| Dados salvos como CSV com sucesso! |" << endl; // Mensagem de sucesso
        cout << " ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾ " << endl;
        ...
        cout << " ______________________________________ " << endl;
        cout << "| Dados salvos como binário com sucesso! |" << endl; // Mensagem de sucesso
        cout << " ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾ " << endl;
    } else {
        cout << " _____________________________________ " << endl;
        cout << "| Erro: Extensao de arquivo invalida! |" << endl; // Mensagem de erro para extensão inválida
        cout << " ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾ " << endl;
    }
}
    ...
    while (continuarMenu) {
        ...
        switch (opcao) {
            ...
            case 3:
                ...
                break;
            case 4:
                escolhertipo(lista, numRegistros); // Chama a função para escolher o tipo de ordenação
                break;
            case 5: 
            ...
            case 6:
                ...
                cout << " _____________________ " << endl;
                cout << "| Programa encerrado! |" << endl; // Mensagem de encerramento
                cout << " ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾ " << endl;
...
int main() {
    limparTela(); // Limpa a tela
    cout << " ___________________________________________________ " << endl;
    cout << "| Bem-vindo ao sistema de gerenciamento de atletas! |" << endl; // Mensagem de boas-vindas
    cout << " ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾ " << endl;
